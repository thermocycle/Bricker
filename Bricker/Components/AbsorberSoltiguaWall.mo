...
Real K_l "Longitudinal Incident Angle Modifier (IAM)";
...
K_l = 1; //cambierà in funzione del theta. perdite al coseno già incluse? non è chiaro dal datasheet
...
Phi_conv_f[i]= (DNI * ( S_eff / S) *S * K_l * 0.747 - S * 0.64 * (T_fluid[i]- Tamb))  / A_ext_t;
