...
model SolarCollectorIncSoltigua
...
redeclare final model Flow1DimIncHeatTransferModel = FluidHeatTransferModel,
    ...
    annotation (Placement(transformation(extent={{-27,-21},{27,21}},
        rotation=90,
        origin={47,19})));
 Bricker.Components.AbsorberSoltigua absorberSoltigua(
...
equation
  connect(Theta, absorberSoltigua.Theta) annotation (Line(
      points={{-68,40},{-52,40},{-52,38},{-42,38},{-42,25.75},{-8.35,25.75}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(DNI, absorberSoltigua.DNI) annotation (Line(
      points={{-66,-26},{-50,-26},{-50,-10},{-32,-10},{-32,14.35},{-8.05,14.35}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(Tamb, absorberSoltigua.Tamb) annotation (Line(
      points={{-70,14},{-40,14},{-40,20.2},{-8.5,20.2}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(Flow1DimInc.OutFlow, OutFlow) annotation (Line(
      ...
      color={0,0,255},
      smooth=Smooth.None));
  connect(Flow1DimInc.Wall_int, absorberSoltigua.wall_int) annotation (Line(
      points={{38.25,19},{18.5,19}},
      color={255,0,0},
      smooth=Smooth.None));
  ...
  connect(absorberSoltigua.Focusing, booleanToInteger.y) annotation (Line(
      points={{-10,6.1},{-17.5,6.1},{-17.5,-63}},
      color={255,127,0},
      smooth=Smooth.None));
