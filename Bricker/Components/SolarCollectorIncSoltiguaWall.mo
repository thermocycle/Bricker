...
model SolarCollectorIncSoltiguaWall
...
final parameter Modelica.SIunits.Volume V_tube_int = pi*D_int_t^2/4*L
    ...
    "specific heat capacity for the metal tube. Stainless Steel = 400 J/kg.K";
        parameter Modelica.SIunits.Density rho_metal_wall=7800
    "specific heat capacity for the metal tube. Stainless Steel = 7800 kg/m^3";
...
redeclare final model Flow1DimIncHeatTransferModel = FluidHeatTransferModel,
    ...
    annotation (Placement(transformation(extent={{-27,-21},{27,21}},
        rotation=90,
        origin={47,19})));
 Bricker.Components.AbsorberSoltiguaWall absorberSoltigua(
...
end SolarCollectorIncSoltiguaWall;
