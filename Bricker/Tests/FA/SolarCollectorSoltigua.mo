...
model SolarCollectorSoltigua
 ...
 ThermoCycle.Components.FluidFlow.Reservoirs.SinkP sinkP(redeclare package
  ...
  Components.SolarCollectorIncSoltigua solarCollectorIncSoltigua(
...
equation
  ...
  connect(solarCollectorIncSoltigua.v_wind, const3.y) annotation (Line(
      points={{-26.4,34.22},{-54.7,34.22},{-54.7,72},{-77,72}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(const1.y, solarCollectorIncSoltigua.Theta) annotation (Line(
      points={{-77,44},{-56,44},{-56,22.34},{-26.4,22.34}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(const.y, solarCollectorIncSoltigua.Tamb) annotation (Line(
      points={{-77,20},{-56,20},{-56,9.92},{-25.8667,9.92}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(sourceMdot.flangeB, solarCollectorIncSoltigua.InFlow) annotation (
      Line(
      points={{-53,-84},{-30,-84},{-30,-16},{-12,-16}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(solarCollectorIncSoltigua.OutFlow, sinkP.flangeB) annotation (Line(
      points={{-12,38.54},{6,38.54},{6,66},{23.6,66}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(booleanStep.y, solarCollectorIncSoltigua.Defocusing) annotation (Line(
      points={{-77,-48},{-60,-48},{-60,-6.28},{-34.9333,-6.28}},
      color={255,0,255},
      smooth=Smooth.None));
  connect(step.y, solarCollectorIncSoltigua.DNI) annotation (Line(
