...
model Test_SF_BiomassSystem_ORC_Hx_II_Simone_V1_4_corretto_finale
  ...
  Modelica.Fluid.Sensors.Temperature Temp_BMSysOut(redeclare package Medium =
        ThermoCycle.Media.Incompressible.IncompressibleTables.TherminolSP)
    annotation (Placement(transformation(extent={{-70,56},{-56,68}})));
...
ThermoCycle.Components.Units.Solar.SolarField_Soltigua_Inc        solarCollectorIncSchott(
 ...
 BrickerISES.Components.Valve_lin ValveSF1(
  ...
  Modelica.Blocks.Sources.TimeTable timeTable(table=[0,0; 3600,0; 7200,0; 10800,
        ...
        850; 39600,800; 43200,700; 46800,650; 50400,600; 54000,500; 57600,300;
 ...
 BrickerISES.Components.Valve_lin ValveSF2(
    ...
    Mdot_nom=0.4,
    Afull=8.7971e-05,
    Xopen=0.344) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-74,20})));
equation
  ...
  connect(Temp_BMSysOut.port, Tank2.InFlow) annotation (Line(
      points={{-63,56},{-58,56},{-58,48},{-23.8,48},{-23.8,47.6}},
      color={0,127,255},
      smooth=Smooth.None));
  ...
  connect(ValveSF1.OutFlow, Tank3.InFlow) annotation (Line(
      points={{30,99},{30,134},{78,134},{78,133.6},{96.2,133.6}},
      color={0,0,255},
      smooth=Smooth.None));
  ...
  connect(Temp_BMin.T, pID.PV) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(ValveSF2.InFlow, MflowSfToBm.port_a) annotation (Line(
      points={{-74,11},{-74,-16},{-102,-16}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(ValveSF2.OutFlow, Tank2.InFlow) annotation (Line(
      points={{-74,29},{-74,48},{-23.8,48},{-23.8,47.6}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(ValveSF1.InFlow, oRCunitHx.InletSf) annotation (Line(
      points={{30,81},{30,48},{71.1429,48},{71.1429,-39.3333}},
      color={0,0,255},
      smooth=Smooth.None));
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-260,
            ...
            -200},{240,160}})));
end Test_SF_BiomassSystem_ORC_Hx_II_Simone_V1_4_corretto_finale;
