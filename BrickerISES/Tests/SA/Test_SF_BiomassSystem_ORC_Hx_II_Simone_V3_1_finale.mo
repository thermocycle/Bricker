...
model Test_SF_BiomassSystem_ORC_Hx_II_Simone_V3_1_finale
...
ThermoCycle.Components.Units.Solar.SolarField_Soltigua_Inc        solarCollector_Soltigua(
 ...
 BrickerISES.Components.Valve_lin ValveSF1(
  ...
  Modelica.Fluid.Sensors.Temperature Temp_HEX_water_inlet(redeclare package
    ...
    annotation (Placement(transformation(extent={{264,102},{242,116}})));
  Modelica.Blocks.Sources.TimeTable timeTable1(table=[0,10; 2000,10; 2001,10;
 ...
 BrickerISES.Components.Valve_lin ValveSF2(
  ...
  Modelica.Fluid.Sensors.Temperature Temp_HEX_water_outlet(redeclare package
      Medium = ThermoCycle.Media.Water)
    annotation (Placement(transformation(extent={{238,146},{216,160}})));
  Modelica.Blocks.Sources.TimeTable timeTable2(table=[0,333; 2000,333; 2001,330;
        8000,330; 8001,330; 9000,330])
    annotation (Placement(transformation(extent={{306,48},{292,62}})));
...
equation
  ...
  connect(Temp_HEX_water_outlet.port, sinkP.flangeB) annotation (Line(
      points={{227,146},{226,146},{226,134},{286,134},{286,137.6}},
      color={0,127,255},
      smooth=Smooth.None));
  connect(timeTable1.y, sourceMdot.in_Mdot) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(timeTable2.y, sourceMdot.in_T) annotation (Line(
      points={{291.3,55},{272,55},{272,45.8},{232,45.8}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(Temp_HEX_water_inlet.port, hx1DInc1.inlet_fl1) annotation (Line(
      points={{253,102},{253,90},{204.923,90},{204.923,97.3462}},
      color={0,127,255},
      smooth=Smooth.None));
  connect(Temp_HEX_water_inlet.T, pID2.PV) annotation (Line(
      points={{245.3,109},{212,109},{212,150},{10,150},{10,99.6},{22,99.6}},
      color={0,0,127},
      smooth=Smooth.None));
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-260,
            ...
            -200},{320,160}})));
end Test_SF_BiomassSystem_ORC_Hx_II_Simone_V3_1_finale;
