...
model Test_SF_BiomassSystem_ORC_Hx_II_Simone_V3_7_prova
...
ThermoCycle.Components.Units.Solar.SolarField_Soltigua_Inc        solarCollector_Soltigua(
 ...
 BrickerISES.Components.Valve_lin ValveSF2(
    ...
    Xopen=0.074,
    DELTAp_nom=0,
    Afull=9e-03) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={12,8})));
...
equation
  ...
  connect(massFlowRate_in_BM2.port_b, pump.InFlow) annotation (Line(
      points={{-48,-23.5},{-54,-23.5},{-54,-33.5},{-106.8,-33.5}},
      color={0,127,255},
      smooth=Smooth.None));
  ...
  connect(Tank1.OutFlow, massFlowRate_totBM.port_a) annotation (Line(
      points={{65.8,-76.4},{65.8,-53.2},{41,-53.2},{41,-31}},
      color={0,0,255},
      smooth=Smooth.None));
  ...
  connect(DpSF2.OutFlow, DpSF3.InFlow) annotation (Line(
      points={{-12.6,36},{6,36},{6,42},{36.6,42}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(ValveSF2.InFlow, massFlowRate_totBM.port_b) annotation (Line(
      points={{12,-1},{14,-1},{14,-22},{13.93,-22.72},{13.93,-31},{27,-31}},
      color={0,0,255},
      smooth=Smooth.None));
  ...
  connect(TempBM_in2.port, pump.InFlow) annotation (Line(
      points={{-80,78},{-82,78},{-82,-20},{-78,-20},{-78,-30},{-54,-30},{-54,
          -33.5},{-106.8,-33.5}},
      color={0,127,255},
      smooth=Smooth.None));
  connect(TempBM_out3.port, ValveSF2.InFlow) annotation (Line(
      ...
      color={0,127,255},
      smooth=Smooth.None));
  connect(massFlowRate_in_BM2.port_a, ValveSF2.InFlow) annotation (Line(
      points={{-29,-23.5},{-8,-23.5},{-8,-24},{14,-24},{14,-1},{12,-1}},
      color={0,127,255},
      smooth=Smooth.None));
  connect(pressure1.port, massFlowRate_totBM.port_b) annotation (Line(
      points={{72,-22},{34,-22},{34,-14},{14,-14},{14,-31},{27,-31}},
      color={0,127,255},
      smooth=Smooth.None));
  connect(pressure.port, DpSF3.InFlow) annotation (Line(
      points={{52,8},{38,8},{38,20},{24,20},{24,42},{36.6,42}},
      color={0,127,255},
      smooth=Smooth.None));
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-260,
            ...
            -200},{440,160}})));
end Test_SF_BiomassSystem_ORC_Hx_II_Simone_V3_7_prova;
