...
model Test_SF_BiomassSystem_ORC_Hx_II_Simone_V5_0_FINALE
...
equation
  ...
  connect(Valve_HEX.OutFlow, pump_HEX_oil.InFlow) annotation (Line(
      points={{76,112.8},{76,141.75},{160.2,141.75}},
      color={0,0,255},
      smooth=Smooth.None));
  ...
  connect(massFlowRate_BM_mix.port_b, oRCunitHx.InletSf) annotation (Line(
      points={{-2,40},{94,40},{94,-28},{164,-28},{164,-27.3333},{165.143,
          -27.3333}},
      color={0,127,255},
      smooth=Smooth.None));
  ...
  connect(pID2.CS, Valve_HEX.cmd) annotation (Line(
      points={{34.3,108},{44,108},{44,102},{61.6,102}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-260,
            ...
            -200},{360,200}})));
end Test_SF_BiomassSystem_ORC_Hx_II_Simone_V5_0_FINALE;
