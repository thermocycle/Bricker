...
model Test7
  ...
  ThermoCycle.Components.Units.ControlSystems.PID pID_HEX(
    ...
    Kp=0.1,
    CSmin=0.1,
    CSmax=8) annotation (Placement(transformation(
        extent={{9.5,7.5},{-9.5,-7.5}},
        rotation=180,
        origin={25.5,189.5})));
  ...
  Modelica.Blocks.Logical.Hysteresis hysteresis(uLow=59 + 273, uHigh=60 + 273)
  ...
  Modelica.Blocks.Sources.TimeTable timeTable1(table=[0,-387000; 20000,-387000;
        25000,-700000; 35000,-700000; 40000,-387000; 50000,-387000])
...
equation
  ...
  connect(sourceMdot.in_T, Qeva1.y) annotation (Line(
      points={{105.8,150},{106,150},{106,195.5},{121,195.5}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(const1.y, pID_HEX.SP) annotation (Line(
      points={{-21.5,191},{-3.75,191},{-3.75,192.5},{16,192.5}},
      color={0,0,127},
      smooth=Smooth.None));
