...
model Test_SF_Adriano_Soltigua_valve_hysteresis_V1_1_with_defocusing
 ...
 BrickerISES.Components.Valve_lin ValveSF(
  ...
  Modelica.Fluid.Sensors.MassFlowRate massFlowRate2(redeclare package Medium =
    ...
    annotation (Placement(transformation(
        ...
        rotation=-90,
        origin={82,6})));
  Modelica.Blocks.Sources.TimeTable timeTable(table=[0,0; 3600,0; 7200,0;
        10800,0; 14400,0; 18000,0; 21600,0; 25200,174.53; 28800,918.575;
        32400,1059.645; 36000,1282.135; 39600,1267.675; 43200,1136.04; 46800,
        1054.33; 50400,600; 54000,500; 57600,300; 61200,100; 64800,0; 68400,0;
        72000,0; 75600,0; 79200,0; 82800,0])
...
equation
  ...
  connect(timeTable.y, solarField_SoltiguaWall_Inc.DNI) annotation (Line(
      points={{-99,-52},{-78,-52},{-78,-3},{-48.2,-3}},
      color={0,0,127},
      smooth=Smooth.None));
...
end Test_SF_Adriano_Soltigua_valve_hysteresis_V1_1_with_defocusing;
