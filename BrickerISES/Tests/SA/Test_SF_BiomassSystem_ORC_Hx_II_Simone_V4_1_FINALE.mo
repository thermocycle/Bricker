...
model Test_SF_BiomassSystem_ORC_Hx_II_Simone_V4_1_FINALE
...
ThermoCycle.Components.Units.Solar.SolarField_Soltigua_Inc        solarCollector_Soltigua(
  ...
  Modelica.Fluid.Sensors.Temperature TempSfSysOut_SF(redeclare package Medium
      = ThermoCycle.Media.Incompressible.IncompressibleTables.TherminolSP)
    annotation (Placement(transformation(extent={{-12,-68},{16,-50}})));
 ...
 BrickerISES.Components.Valve_lin Valve_HEX(
  ...
  Modelica.Fluid.Sensors.Temperature T_inlet_ORC(redeclare package Medium =
        ThermoCycle.Media.Incompressible.IncompressibleTables.TherminolSP)
    annotation (Placement(transformation(extent={{20,48},{48,66}})));
  Modelica.Blocks.Sources.TimeTable timeTable2(table=[0,0; 1000,0; 1001,400;
        ...
        9001,0; 10000,0])
    annotation (Placement(transformation(extent={{-200,-158},{-186,-144}})));
equation
  ...
  connect(hx1DInc1.outlet_fl2, Mflow_HEX_oil.port_a) annotation (Line(
      points={{195.369,97.5692},{194,97.5692},{194,58},{108,58},{108,-64}},
      color={0,0,255},
      smooth=Smooth.None));
  ...
  connect(Mflow_recirculation_HEX.port_a, Mflow_HEX_oil.port_a) annotation (
      Line(
      points={{145,78},{145,58},{108,58},{108,-64}},
      color={0,127,255},
      smooth=Smooth.None));
  ...
  connect(massFlowRate_mix.port_b, oRCunitHx.InletSf) annotation (Line(
      points={{4,40},{94,40},{94,-28},{164,-28},{164,-27.3333},{165.143,
          -27.3333}},
      color={0,127,255},
      smooth=Smooth.None));
  connect(const5.y, pID2.SP) annotation (Line(
      points={{-3.5,143},{4.25,143},{4.25,106.4},{22,106.4}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(pID2.CS, Valve_HEX.cmd) annotation (Line(
      points={{32.3,104},{44,104},{44,103},{70.4,103}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(Temp_HEX_water_inlet.T, pID2.PV) annotation (Line(
      points={{247.7,105},{216,105},{216,150},{10,150},{10,101.6},{22,101.6}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(massFlowRate_in_BM2.port_b, pump.InFlow) annotation (Line(
      points={{14,-13},{-32,-13},{-32,-33.5},{-106.8,-33.5}},
      color={0,127,255},
      smooth=Smooth.None));
  connect(Mflow_Bm_out.port_b, Mflow_BmRecirculation.port_a) annotation (Line(
      points={{-92,38.5},{-62,38.5},{-62,16}},
      color={0,127,255},
      smooth=Smooth.None));
  connect(Tank1.OutFlow, massFlowRate_in_BM2.port_a) annotation (Line(
      points={{65.8,-76.4},{65.8,-76},{80,-76},{80,-13},{41,-13}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(Mflow_BmRecirculation.port_b, pump.InFlow) annotation (Line(
      points={{-62,-12},{-62,-33.5},{-106.8,-33.5}},
      color={0,127,255},
      smooth=Smooth.None));
  connect(Valve_HEX.InFlow, massFlowRate_mix.port_b) annotation (Line(
      points={{80,91.3},{80,40},{4,40}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(T_inlet_ORC.port, massFlowRate_mix.port_b) annotation (Line(
      points={{34,48},{34,40},{4,40}},
      color={0,127,255},
      smooth=Smooth.None));
  connect(timeTable2.y, solarCollector_Soltigua.DNI) annotation (Line(
      points={{-185.3,-151},{-174,-151},{-174,-126.136},{-151.9,-126.136}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(Mflow_HEX_oil.port_b, MflowToSf.port_a) annotation (Line(
      ...
      color={0,127,255},
      smooth=Smooth.None));
  connect(massFlowRate_mix.port_a, Mflow_BmRecirculation.port_a) annotation (
      Line(
      points={{-24,40},{-62,40},{-62,14},{-62,14},{-62,16},{-62,16}},
      color={0,127,255},
      smooth=Smooth.None));
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-260,
            ...
            -200},{440,160}})));
end Test_SF_BiomassSystem_ORC_Hx_II_Simone_V4_1_FINALE;
