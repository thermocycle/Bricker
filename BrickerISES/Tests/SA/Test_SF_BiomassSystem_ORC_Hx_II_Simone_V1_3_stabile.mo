...
model Test_SF_BiomassSystem_ORC_Hx_II_Simone_V1_3_stabile
  ...
  BrickerISES.Components.Biomass.Flow1DIncHeatInput flow1DIncHeatInput(
    ...
    Tstart_outlet_wall=488.15,
    QcombustionStart=150e3) annotation (Placement(transformation(
        extent={{24,-31},{-24,31}},
        rotation=90,
        origin={-179,24})));
...
equation
  ...
  connect(TempSfSysOut1.port, massFlowRate3.port_a) annotation (Line(
      ...
      color={0,127,255},
      smooth=Smooth.None));
  connect(pID.PV, TempSfSysOut1.T) annotation (Line(
      points={{-66,-44.4},{-50,-44.4},{-50,-32},{-34.7,-32}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-260,
            ...
            -200},{240,160}})));
end Test_SF_BiomassSystem_ORC_Hx_II_Simone_V1_3_stabile;
