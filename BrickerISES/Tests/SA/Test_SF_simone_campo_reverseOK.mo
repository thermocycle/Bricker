...
model Test_SF_simone_campo_reverseOK
 ...
 BrickerISES.Components.Valve_lin ValveSF(
  ...
  Modelica.Blocks.Sources.Ramp ramp1(
    ...
    offset=11) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={118,74})));
  Modelica.Blocks.Sources.Constant const2(k=0.004)
...
equation
  ...
  connect(const2.y, ValveSF.cmd) annotation (Line(
      points={{58,49},{56,49},{56,56},{54,56}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(sourceMdot.in_Mdot, ramp1.y) annotation (Line(
      points={{92,94},{118,94},{118,85}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(sourceMdot.flangeB, pump.InFlow) annotation (Line(
      points={{86,79},{88,79},{88,-41.5},{19.2,-41.5}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(DpSF.InFlow, massFlowRate.port_b) annotation (Line(
      points={{20,46.6},{24,46.6},{24,28},{32,28},{32,4}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(massFlowRate.port_a, pump.InFlow) annotation (Line(
      points={{32,-16},{32,-42},{19.2,-41.5}},
      color={0,127,255},
      smooth=Smooth.None));
...
end Test_SF_simone_campo_reverseOK;
