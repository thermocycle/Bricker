...
model Test_SF_BiomassSystem_ORC_Hx_II_Simone_V2_2_finale
...
equation
  ...
  connect(Mflow_BmRecirculation.port_a, Mflow_Bm_out.port_b) annotation (Line(
      points={{-57,16},{-56,16},{-56,38},{-74,38},{-74,38.5},{-92,38.5}},
      color={0,127,255},
      smooth=Smooth.None));
  ...
  connect(ValveSF1.InFlow, Mflow_Bm_out.port_b) annotation (Line(
      points={{62,91},{64,91},{64,38},{-74,38},{-74,38.5},{-92,38.5}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(oRCunitHx.InletSf, Mflow_Bm_out.port_b) annotation (Line(
      points={{165.143,-27.3333},{96,-27.3333},{96,8},{66,8},{66,38},{-74,38},{
          -74,38.5},{-92,38.5}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(Inlet_orc.port, oRCunitHx.InletSf) annotation (Line(
      points={{136,-10},{138,-10},{138,-27.3333},{165.143,-27.3333}},
      color={0,127,255},
      smooth=Smooth.None));
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-260,
            ...
            -200},{240,160}})));
end Test_SF_BiomassSystem_ORC_Hx_II_Simone_V2_2_finale;
