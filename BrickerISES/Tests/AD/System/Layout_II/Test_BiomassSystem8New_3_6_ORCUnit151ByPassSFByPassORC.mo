within BrickerISES.Tests.AD.System.Layout_II;
...
equation
  ...
  connect(const4.y, oRCunitHx.MdotWfORC) annotation (Line(
      points={{310,111},{286,111},{286,120},{284.286,120},{284.286,44.5333}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(const5.y, oRCunitHx.TWfORCSu) annotation (Line(
      points={{346,119},{346,44.5333},{305.714,44.5333}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(valve1.OutFlow, dP1.OutFlow) annotation (Line(
      points={{194,29},{196,29},{196,-100},{190,-100},{190,-102},{207,-102}},
      color={0,0,255},
      smooth=Smooth.None));

  connect(valve1.InFlow, oRCunitHx.InletSf) annotation (Line(
      points={{194,47},{194,122},{186,122},{186,120},{261.143,120},{261.143,
          38.6667}},
      color={0,0,255},
      smooth=Smooth.None));
