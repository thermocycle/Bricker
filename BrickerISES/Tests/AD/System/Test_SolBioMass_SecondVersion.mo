...
model Test_SolBioMass_SecondVersion
...
equation
  ...
  connect(const.y, simpleBiomassBoiler.Q) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(pump1.InFlow, simpleBiomassBoiler.outlet) annotation (Line(
      points={{-56.8,-17.5},{110,-17.5},{110,82.32},{76,82.32}},
      color={0,0,255},
      smooth=Smooth.None));
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{
            -120,-100},{140,140}}), graphics), Icon(coordinateSystem(extent={
            {-120,-100},{140,140}})));
end Test_SolBioMass_SecondVersion;
