...
model Test_BiomassSystem8New_4
...
equation
  ...
  connect(dP1.OutFlow, ORC.InFlowSf) annotation (Line(
      points={{61,116},{191.2,116},{191.2,70.7111}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(ORC.InFlowCf, source_cf.flangeB) annotation (Line(
      ...
      color={0,0,255},
      smooth=Smooth.None));
  connect(ORC.OutFlowSf, solarCollectorIncSchott.InFlow) annotation (Line(
      points={{191.2,50.0444},{160,50.0444},{160,10},{258,10},{258,-134},{238,
          -134},{238,-144},{-72.8,-144},{-72.8,-108.636}},
      color={0,0,255},
      smooth=Smooth.None));
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-160,
            -160},{280,140}}), graphics), Icon(coordinateSystem(extent={{-160,
            -160},{280,140}})));
end Test_BiomassSystem8New_4;
