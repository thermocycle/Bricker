...
model System_ORC_Unit
  ...
  ThermoCycle.Components.Units.PdropAndValves.Valve valve(
    ...
    DELTAp_nom=100000,
    constinit=false)
    annotation (Placement(transformation(extent={{-52,194},{-32,214}})));
  ...
  ThermoCycle.Components.Units.ExpansionAndCompressionMachines.Pump pump_TO_BM(
    ...
    V_dot_max=0.002646,
    hstart=479180)
    annotation (Placement(transformation(extent={{2,140},{-18,160}})));
  ...
  Components.ORC_Unit oRC_Unit(T_oil_ex=423.15, p_start=150000)
    annotation (Placement(transformation(extent={{148,126},{192,176}})));
equation
  ...
  connect(TJ1.port_3, valve.InFlow) annotation (Line(
      points={{-54,262},{-54,238},{-62,238},{-62,204},{-51,204}},
      color={0,127,255},
      smooth=Smooth.None));
  connect(valve.OutFlow, TJ2.port_3) annotation (Line(
      points={{-33,204},{-26,204},{-26,182},{-48,182},{-48,164}},
      color={0,0,255},
      smooth=Smooth.None));
  ...
  connect(Tank_SF.OutFlow, pump_TO_BM.InFlow) annotation (Line(
      points={{21.76,81.92},{40,81.92},{40,150.5},{-0.8,150.5}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(pump_TO_BM.OutFlow, TJ2.port_1) annotation (Line(
      points={{-13.6,157.4},{-26,157.4},{-26,154},{-38,154}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(Sens_ORC_EX.InFlow, pump_TO_BM1.OutFlow) annotation (Line(
      points={{-25.8,-56.88},{24.1,-56.88},{24.1,-38.6},{76.4,-38.6}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(Sens_SBM_SU.OutFlow, oRC_Unit.InFlow) annotation (Line(
      points={{27.5,271.8},{148.8,271.8},{148.8,173.15}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(oRC_Unit.OutFlow, pump_TO_BM1.InFlow) annotation (Line(
      points={{148.4,131.181},{148.4,-45.5},{89.2,-45.5}},
      color={0,0,255},
      smooth=Smooth.None));
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-240,
    ...
    Icon(coordinateSystem(extent={{-240,-80},{200,300}})));
end System_ORC_Unit;
