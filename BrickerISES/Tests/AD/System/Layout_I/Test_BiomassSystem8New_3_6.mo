...
model Test_BiomassSystem8New_3_6
...
ThermoCycle.Components.Units.Solar.SolarField_Soltigua_Inc        solarCollectorIncSchott(
  ...
  Modelica.Blocks.Sources.Constant const2(
                                         k=25)
    annotation (Placement(transformation(extent={{-182,-70},{-162,-50}})));
  ...
  ThermoCycle.Components.Units.Tanks.OpenTank Tank(
    ...
    Tstart=518.15,
    pstart=400000)
    annotation (Placement(transformation(extent={{116,114},{136,134}})));
equation
  ...
  connect(const2.y, solarCollectorIncSchott.Tamb) annotation (Line(
      points={{-161,-60},{-152,-60},{-152,-81.0909},{-85.6667,-81.0909}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(PdropBMout.OutFlow, Tank.InFlow) annotation (Line(
      points={{61,116},{116.2,116},{116.2,115.6}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(Tank.OutFlow, hx1DInc.inlet_fl2) annotation (Line(
      points={{135.8,115.6},{196.846,115.6},{196.846,66.8462}},
      color={0,0,255},
      smooth=Smooth.None));
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-200,
            -200},{300,140}}), graphics), Icon(coordinateSystem(extent={{-200,
            -200},{300,140}})));
end Test_BiomassSystem8New_3_6;
