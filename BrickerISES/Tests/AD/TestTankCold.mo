...
model TestTankCold
 ...
 BrickerISES.Components.StraTank tank_7h_cold(
    redeclare package Medium = CoolProp2Modelica.Media.WaterTPSI_FP,
    N=31,
    Tstart=(202 + 273.15)*ones(30),
    Vlstart=36.7,
    k_fluid=0.039333856,
    k_wall=32,
    U_env_bottom=0,
...
equation
  ...
  connect(sourceMdot.flangeB, tank_7h_cold.portHotSF) annotation (Line(
      ...
      color={0,0,255},
      smooth=Smooth.None));
  connect(tank_7h_cold.portColdSF, sinkMdot.flangeB) annotation (Line(
      points={{-31.6,-19.77},{-47.8,-19.77},{-47.8,-24},{-64.2,-24}},
      color={0,0,255},
      smooth=Smooth.None));
