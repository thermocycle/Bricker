...
equation
  ...
  connect(sinkP1.flangeB, oRCunit.OutFlowSf) annotation (Line(
      points={{0.4,-84},{32,-84},{32,-69.6},{43.8,-69.6}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(pump1.OutFlow, hx1DInc.inlet_fl1) annotation (Line(
      points={{-44.4,-28.6},{-34,-28.6},{-34,1.53846},{-24.2308,1.53846}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(sourceP.flange, pump1.InFlow) annotation (Line(
      points={{-80.6,-56},{-68,-56},{-68,-35.5},{-57.2,-35.5}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(hx1DInc.outlet_fl1, sinkP2.flangeB) annotation (Line(
      points={{14.2308,1.53846},{30,1.53846},{30,-8},{39.6,-8},{39.6,-6}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(sourceMdot1.flangeB, oRCunit.InFlowSf) annotation (Line(
      points={{5,-36},{24,-36},{24,-63.6},{43.8,-63.6}},
      color={0,0,255},
      smooth=Smooth.None));
