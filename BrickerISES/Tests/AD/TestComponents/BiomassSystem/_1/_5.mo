...
Components.Valve_lin             valve2(
  ...
  Modelica.Blocks.Sources.Constant const(k=358e3)
  ...
  ThermoCycle.Components.HeatFlow.Sources.HeatSource heatSource(
    N=10,
    HeatFlow=true,
    A=90) annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-148,4})));
  ...
  ThermoCycle.Components.FluidFlow.Sensors.SensTp sensTp1(redeclare package
      Medium =
        ThermoCycle.Media.Incompressible.IncompressibleTables.TherminolSP)
    annotation (Placement(transformation(extent={{-116,66},{-96,86}})));
...
equation
  ...
  connect(const.y, heatSource.Phi) annotation (Line(
      points={{-165,-5.5},{-165,4},{-152,4}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(heatSource.thermalPort, flow1DimInc.Wall_int) annotation (Line(
      points={{-143.9,3.9},{-140.95,3.9},{-140.95,4},{-133,4}},
      color={255,0,0},
      smooth=Smooth.None));
  ...
  connect(dP.OutFlow, sensTp1.InFlow) annotation (Line(
      points={{-128,45},{-128,68},{-113,68},{-113,71.2}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(sensTp1.OutFlow, sensMdot1.InFlow) annotation (Line(
      points={{-99,71.2},{-60,71.2},{-60,70},{-18,70}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(sensMdot.InFlow, sensMdot1.InFlow) annotation (Line(
      points={{-56,22},{-62,22},{-62,24},{-72,24},{-72,56},{-62,56},{-62,70},{
          -18,70}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(dP1.OutFlow, sensTp.InFlow) annotation (Line(
      points={{-15,-22},{-24,-22},{-24,-44},{-44,-44},{-44,-50.8},{-81,-50.8}},
      color={0,0,255},
      smooth=Smooth.None));

  connect(sensMdot.OutFlow, sensTp2.InFlow) annotation (Line(
      points={{-48,22},{-40,22},{-40,8},{-31,8},{-31,7.2}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(sensTp2.OutFlow, sensTp.InFlow) annotation (Line(
      points={{-17,7.2},{-6,7.2},{-6,-8},{-48,-8},{-48,-50},{-81,-50.8}},
      color={0,0,255},
      smooth=Smooth.None));
