...
package Layout_II
  package SizingSimpleValve
    ...
    equation
      ...
      connect(sourceP.flange, valve.InFlow) annotation (Line(
          points={{-60.6,-2},{-32,-2},{-32,0},{-9,0}},
          color={0,0,255},
          smooth=Smooth.None));
      connect(valve.OutFlow, sinkP1.flangeB) annotation (Line(
          points={{9,0},{36,0},{36,-2},{59.6,-2}},
          color={0,0,255},
          smooth=Smooth.None));
      annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
                -100},{100,100}}), graphics),Documentation(info="<html>
            <p>Model to size the valve for solar field bypass
            <p> The mass flow through it is 1.7 kg/s in nominal condition
            <p> The fraction of the valve area open is set to 60% which is 
            <p> the percentage of flow with respect to the nominal one: 2.7*60/100 = 1.7 Not really following this in the last example
    ...
    equation
      ...
      annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
                -100},{100,100}}), graphics),Documentation(info="<html>
            <p>Model to size the valve for solar field bypass
            <p> The mass flow through it is 7.62 kg/s in nominal condition
            <p> The fraction of the valve area open is set to 81.06% which is 
            <p> the percentage of flow with respect to the nominal one: 9.4*81.06/100 = 7.62                         
</html>"));
