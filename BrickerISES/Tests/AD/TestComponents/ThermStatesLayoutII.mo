...
parameter Modelica.SIunits.MassFlowRate M_su_pp_Hx = 3.8
    ...
    /* Parameters ORC inlet */
parameter Modelica.SIunits.Temperature T_in_orc = 245+273.15
    "Temperature at the inlet of the Hx pump";
parameter Modelica.SIunits.MassFlowRate M_in_orc = 2.5
    "Mass flow through the Hx pump";

    /* Parameters ORC outlet */
parameter Modelica.SIunits.Pressure p_out_orc = 5.5e5
    "pressure at the inlet of the Hx pump";
parameter Modelica.SIunits.Temperature T_out_orc = 173+273.15
    "Temperature at the inlet of the Hx pump";
...
/*Variables orc out */
Medium.ThermodynamicState fs_in_orc = Medium.setState_pT(p_out_orc,T_in_orc);
Medium.SpecificEnthalpy h_in_orc;
...
Real Q_ORC_eva;
equation
  cp_su_pp = Medium.specificHeatCapacityCp(fs_su_pp_sf);
 ...
 h_in_orc = Medium.specificEnthalpy(fs_in_orc);
 V_out_orc = M_out_orc/rho_out_orc;
 V_max_out_orc = V_out_orc/(X_pp);

 Q_ORC_eva = M_out_orc*(h_in_orc-h_out_orc);
