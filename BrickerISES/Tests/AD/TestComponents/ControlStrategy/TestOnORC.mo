...
model TestOnORC
 ...
 BrickerISES.Components.Valve_lin ValveSF(
  ...
  ThermoCycle.Components.Units.ExpansionAndCompressionMachines.Pump PumpHxOil_2(
    ...
    eta_is=0.85,
    p_su_start=350000)
    annotation (Placement(transformation(extent={{-46,252},{-16,282}})));
...
BrickerISES.Components.SF.SF_SoltiguaL_IncNoWall SF(
  ...
  Modelica.Blocks.Logical.Hysteresis hysTOut(uLow=10, uHigh=150)
    ...
    annotation (Placement(transformation(extent={{-434,32},{-420,46}})));
  ...
  Components.GeneralCombiTableModel.GeneralCombiTable generalCombiTable(
    ...
    annotation (Placement(transformation(extent={{-450,-42},{-430,-22}})));
equation
   /* Energy calculation */
  ...
  connect(MflowHX_Recirculation.port_b, PumpHxOil_2.InFlow) annotation (Line(
      points={{-60,236},{-60,267.75},{-41.8,267.75}},
      color={0,127,255},
      smooth=Smooth.None));
  ...
  connect(Temp_HEX_oil_inlet.port, PumpHxOil_2.OutFlow) annotation (Line(
      points={{-4,302},{-10,302},{-10,278.1},{-22.6,278.1}},
      color={0,127,255},
      smooth=Smooth.None));
  connect(PumpHxOil_1.InFlow, MflowBM_mix.port_b) annotation (Line(
      points={{-121.75,234.2},{-121.875,234.2},{-121.875,186},{-210,186}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(PumpHxOil_1.OutFlow, PumpHxOil_2.InFlow) annotation (Line(
      points={{-132.1,253.4},{-130,253.4},{-130,268},{-84,268},{-84,267.75},{
          -41.8,267.75}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(pID2.CS, PumpHxOil_1.flow_in) annotation (Line(
      points={{-163.7,234},{-148,234},{-148,240.2},{-133,240.2}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(PumpHxOil_2.OutFlow,HxOilWater. InFlowSs) annotation (Line(
      points={{-22.6,278.1},{-8,278.1},{-8,253.2},{-4.56,253.2}},
      color={0,0,255},
      smooth=Smooth.None));
  ...
  connect(hysTOut.u, SF.DNI) annotation (Line(
      points={{-435.4,39},{-448,39},{-448,12},{-422,12},{-422,-16},{-378,-16},{
          -378,-1.04545},{-358.1,-1.04545}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(hysTOut.y, not2.u) annotation (Line(
      points={{-419.3,39},{-416,39},{-416,80},{-438,80},{-438,98},{-414,98}},
      color={255,0,255},
      smooth=Smooth.None));
