...
ThermoCycle.Components.Units.Solar.SolarField_Soltigua_Inc SF(
  ...
  Modelica.Blocks.Sources.Constant const4(k=518)
    annotation (Placement(transformation(extent={{-244,52},{-234,62}})));
  ...
  ThermoCycle.Components.Units.ControlSystems.PID pID2(
    ...
    Ti=0.2)  annotation (Placement(transformation(
        ...
        rotation=0,
        origin={29,108})));
  Modelica.Blocks.Sources.Constant const5(k=343)
...
equation
  ...
  connect(DpSF.OutFlow, MflowSF_mix.port_a) annotation (Line(
      points={{-38.6,-76},{9,-76},{9,-76.5}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(MflowSF_mix.port_b, Tank1.InFlow) annotation (Line(
      points={{38,-76.5},{43.5,-76.5},{43.5,-76.4},{52.2,-76.4}},
      color={0,127,255},
      smooth=Smooth.None));
  ...
  connect(TempSfSysOut_SF.port, MflowSF_mix.port_a) annotation (Line(
      points={{2,-68},{2,-76},{9,-76},{9,-76.5}},
      color={0,127,255},
      smooth=Smooth.None));
  connect(const4.y, pID1.SP) annotation (Line(
      points={{-233.5,57},{-218,57},{-218,44.4}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(Temp_BMout.T, pID1.PV) annotation (Line(
      points={{-141.3,79},{-118,79},{-118,84},{-248,84},{-248,39.6},{-218,39.6}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(Temp_BMout.port, BM.outlet_fl2) annotation (Line(
      points={{-149,72},{-150.72,25.52},{-150.72,45.52}},
      color={0,127,255},
      smooth=Smooth.None));
  ...
  connect(BM.outlet_fl2, MflowBM_out.port_a) annotation (Line(
      points={{-150.72,45.52},{-132.36,45.52},{-132.36,58.5},{-123,58.5}},
      color={0,0,255},
      smooth=Smooth.None));
  ...
  connect(PumpHxOil_1.InFlow, MflowBM_mix.port_b) annotation (Line(
      points={{78.25,102.2},{76.125,102.2},{76.125,60},{-10,60}},
      color={0,0,255},
      smooth=Smooth.None));
