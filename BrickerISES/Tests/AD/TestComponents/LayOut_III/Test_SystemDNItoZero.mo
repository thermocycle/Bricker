...
model Test_SystemDNItoZero
  ...
  Modelica.Fluid.Sensors.Temperature TempBMOut(redeclare package Medium =
        ThermoCycle.Media.Incompressible.IncompressibleTables.TherminolSP)
    annotation (Placement(transformation(extent={{-184,90},{-162,104}})));
 ...
 BrickerISES.Components.Valve_lin ValveSF(
  ...
  Modelica.Fluid.Sensors.Temperature TempSFOut(redeclare package Medium =
        ThermoCycle.Media.Incompressible.IncompressibleTables.TherminolSP)
    annotation (Placement(transformation(extent={{-160,-68},{-178,-52}})));
...
ThermoCycle.Components.Units.Solar.SolarField_Soltigua_Inc SF(
  ...
  ThermoCycle.Components.Units.ControlSystems.PID PID_v_SF(
    ...
    Kp=-0.1) annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-21,-64})));
  Modelica.Blocks.Sources.Constant SP_PID_v_SF(k=238.85 + 273.15)
  ...
  ThermoCycle.Components.Units.ControlSystems.PID PID_BM(
    ...
    Ti=0.2) annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-214,52})));
  Modelica.Blocks.Sources.Constant SP_PID_BM(k=244.85 + 273.15)
  ...
  Modelica.Fluid.Sensors.Temperature TempORCOut(redeclare package Medium =
        ThermoCycle.Media.Incompressible.IncompressibleTables.TherminolSP)
    annotation (Placement(transformation(extent={{174,-104},{198,-88}})));
  ...
  Modelica.Fluid.Sensors.Temperature TempHXWaterIn(redeclare package Medium =
    ...
    annotation (Placement(transformation(extent={{258,96},{236,112}})));
  Modelica.Blocks.Sources.TimeTable WaterTableTFlowRate(table=[0,8; 2000,11;
        2001,11; 7000,11; 7001,15; 9000,15])
    annotation (Placement(transformation(extent={{274,40},{260,54}})));
  ...
  ThermoCycle.Components.Units.ControlSystems.PID PID_PumpHXOil_1(
    ...
    Ti=0.2) annotation (Placement(transformation(
        ...
        rotation=0,
        origin={29,108})));
  Modelica.Blocks.Sources.Constant SP_PID_PumpHXOil_1(k=69.85 + 273.15)
  ...
  Modelica.Fluid.Sensors.Temperature TempHXWaterOut(redeclare package Medium =
        ThermoCycle.Media.Water)
    annotation (Placement(transformation(extent={{242,150},{214,168}})));
  ...
  ThermoCycle.Components.Units.ExpansionAndCompressionMachines.Pump PumpHxOil_1(
    ...
    p_su_start=350000) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={79,113})));
  Modelica.Blocks.Sources.Constant DNI(k=0)
    annotation (Placement(transformation(extent={{-202,-148},{-192,-138}})));
equation
  ...
  connect(TempSFOut.T, hysteresis.u) annotation (Line(
      points={{-175.3,-60},{-208,-60},{-208,-184},{-193.2,-184}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(TempSFOut.port, SF.OutFlow) annotation (Line(
      points={{-169,-68},{-126,-68},{-126,-80.6364}},
      color={0,127,255},
      smooth=Smooth.None));
  ...
  connect(TempBMOut.T, PID_BM.PV) annotation (Line(
      points={{-165.3,97},{-132,97},{-132,118},{-262,118},{-262,48},{-222,48}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(TempORCOut.port, DpORC.InFlow) annotation (Line(
      points={{186,-104},{164,-104},{164,-126.6}},
      color={0,127,255},
      smooth=Smooth.None));
  connect(TempBMOut.port, BM.outlet_fl2) annotation (Line(
      points={{-173,90},{-173,73.52},{-160.72,73.52}},
      color={0,127,255},
      smooth=Smooth.None));
  ...
  connect(BM.outlet_fl2, MflowBM_out.port_a) annotation (Line(
      points={{-160.72,73.52},{-160.36,73.52},{-160.36,86.5},{-113,86.5}},
      color={0,0,255},
      smooth=Smooth.None));
  ...
  connect(TempHXWaterOut.port, WaterSink.flangeB) annotation (Line(
      points={{228,150},{226,150},{226,134},{306,134},{306,137.6}},
      color={0,127,255},
      smooth=Smooth.None));
  connect(WaterTableTFlowRate.y, WaterSource.in_Mdot) annotation (Line(
      points={{259.3,47},{245.65,47},{245.65,40},{232,40}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(DNI.y, SF.DNI) annotation (Line(
      points={{-191.5,-143},{-176,-143},{-176,-126.136},{-151.9,-126.136}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(TempORCIn.port, ORC.InletSf) annotation (Line(
      points={{47,58},{46,58},{46,54},{20,54},{20,84},{94,84},{94,-28},{164,-28},
          {164,-27.3333},{165.143,-27.3333}},
      color={0,127,255},
      smooth=Smooth.None));
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-280,
            -240},{360,200}}), graphics), Icon(coordinateSystem(extent={{-280,
            -240},{360,200}})),
    experiment(StopTime=8000),
    __Dymola_experimentSetupOutput);
end Test_SystemDNItoZero;
