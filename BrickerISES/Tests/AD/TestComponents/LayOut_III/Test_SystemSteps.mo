...
ThermoCycle.Components.Units.Solar.SolarField_Soltigua_Inc SF(
  ...
  ThermoCycle.Components.Units.ExpansionAndCompressionMachines.Pump PumpHxOil_1(
    ...
    p_su_start=350000) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={79,113})));
  Modelica.Blocks.Sources.TimeTable DNI_Table(table=[0,0; 1000,0; 1001,400;
        3000,400; 3001,550; 5000,550; 5001,550; 6000,550; 6001,400; 9000,400;
        9001,0; 10000,0])
    annotation (Placement(transformation(extent={{-250,-156},{-236,-142}})));
equation
  ...
  connect(MflowBM_mix.port_b, ORC.InletSf) annotation (Line(
      points={{-10,66},{94,66},{94,-28},{164,-28},{164,-27.3333},{165.143,
          -27.3333}},
      color={0,127,255},
      smooth=Smooth.None));
  ...
  connect(PumpHxOil_1.InFlow, MflowBM_mix.port_b) annotation (Line(
      points={{78.25,102.2},{84.125,102.2},{84.125,66},{-10,66}},
      color={0,0,255},
      smooth=Smooth.None));
  ...
  connect(PID_PumpHXOil_1.CS, PumpHxOil_1.flow_in) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(DNI_Table.y, SF.DNI) annotation (Line(
      points={{-235.3,-149},{-235.3,-150},{-174,-150},{-174,-126.136},{-151.9,
          -126.136}},
      color={0,0,127},
      smooth=Smooth.None));
