...
// Time	0	s
  ...
  ThermoCycle.Components.FluidFlow.Reservoirs.SinkP sinkP(redeclare package
    ...
    p0=400000,
    h=551.7)    annotation (Placement(transformation(extent={{94,44},{114,64}})));
...
equation
  ...
  connect(flow1DIncHeatInput.outlet_fl2, openTank.InFlow) annotation (Line(
      points={{-142.12,32.5},{-142.12,61.6},{-125.8,61.6}},
      color={0,0,255},
      smooth=Smooth.None));
  connect(openTank.OutFlow, valve2.InFlow) annotation (Line(
      points={{-106.2,61.6},{-62,61.6},{-62,62},{-22,62},{-22,50},{7,50}},
      color={0,0,255},
      smooth=Smooth.None));
