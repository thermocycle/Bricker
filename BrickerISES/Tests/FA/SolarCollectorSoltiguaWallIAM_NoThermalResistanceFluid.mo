...
model SolarCollectorSoltiguaWallIAM_NoThermalResistanceFluid
  "The heat transfer without thermal resistance is not working with the presence of the Wall. A very high heat transfer coefficient is instead assumed (with constant heat transfer) in order to simulate the absence of thermal resistance for the fluid"
...
end SolarCollectorSoltiguaWallIAM_NoThermalResistanceFluid;
