...
package Constants "Constants package"
  ...
  "Smallest value such that 1.0 + eps != 1.0";
    ...
    // FLUID CALCULATION FINAL CONSTANT
    final constant Modelica.SIunits.Density rho_Therminol66=1008
  "density of therminol66 at 20°C. Used for volumetric to massic flow conversion in Nominal Conditions";
