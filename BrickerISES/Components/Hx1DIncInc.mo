...
parameter Boolean steadystate_T_wf=false
...
/******************************* COMPONENTS ***********************************/
  ...
  ThermoCycle.Components.FluidFlow.Pipes.Flow1DimInc
  ...
  ThermoCycle.Components.HeatFlow.Walls.CountCurr countCurr(N=N, counterCurrent=
       counterCurrent)
