...
model Expansion_Tank_One_Port_LinearCharacteristic_NoGood
  "Storage tank with a cushion of gas - (Nitrogen) - An ideal system of charging and discharging gas is considered."
...
parameter Modelica.SIunits.Pressure p_max_tank
    "Maximum pressure in the tank: when the tank is half full of fluid";
parameter Modelica.SIunits.Pressure p_min_tank
    "Maximum pressure in the tank: when the tank is completely full of gas";

/* ideal gas Parameter */
final parameter Real V_gas_min = 0.5*V_tank
    "Minimum fraction of volume occupied by the gas";
final parameter Real V_gas_max = V_tank
    "Minimum fraction of volume occupied by the gas";

final parameter Real nn_gas_min = (p_max_tank / (RR*T_gas))  * V_gas_min
    "Number of moles of gas";

final parameter Real nn_gas_max = (p_min_tank / (RR*T_gas))  * V_gas_max
    "Number of moles of gas";

final parameter Real kk = (p_min_tank - p_max_tank) / ( nn_gas_max - nn_gas_min)
    "Slope of linear characteristic between tank pressure and number of moles of the gas";
...
Real nn_gas "Number of moles of gas in the tank";
 ...
 M_dot = InFlow.m_flow;
  ...
  annotation (Diagram(graphics), Icon(graphics={
        ...
        Rectangle(
          ...
          lineColor={0,0,0},
          fillPattern=FillPattern.Solid)}));
end Expansion_Tank_One_Port_LinearCharacteristic_NoGood;
