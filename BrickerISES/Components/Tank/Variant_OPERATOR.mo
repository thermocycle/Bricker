...
model Variant_OPERATOR
//( /*redeclare*/ replaceable /*parameter */ CollectorGeometry geometry)
 replaceable parameter
    ThermoCycle.Components.HeatFlow.Walls.SolarAbsorber.Geometry.VARIANT_OPERATOR.BaseGeometry
                                                                                               geometry
constrainedby
    ThermoCycle.Components.HeatFlow.Walls.SolarAbsorber.Geometry.VARIANT_OPERATOR.BaseGeometry
                                                                                                        annotation (choicesAllMatching=true);

  ThermoCycle.Components.HeatFlow.Walls.SolarAbsorber.AbsSoltigua absSoltigua( geometry =  geometry)
...
equation
  ...
  connect(Theta, absSoltigua.Theta) annotation (Line(
      points={{-106,44},{-94,44},{-94,42},{-82,42},{-82,23.35},{-37.58,23.35}},
      color={0,0,127},
      smooth=Smooth.None));

  annotation (Diagram(graphics));
end Variant_OPERATOR;
