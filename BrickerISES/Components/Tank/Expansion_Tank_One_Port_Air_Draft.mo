...
model Expansion_Tank_One_Port_Air_Draft
  "Storage tank with a cushion of gas - (Nitrogen)"
replaceable package Filling_Medium = ThermoCycle.Media.AirCP constrainedby
...
/* ideal gas Parameter */
final parameter Real nn_gas = (p_min_tank / (RR*T_gas))  * V_gas_max
...
/********** Variables ****************/
Medium.ThermodynamicState  fluidState_air;
...
fluidState_air = Medium.setState_ph(p,h);
...
/*Mass Flow*/
InFlow.m_flow = M_dot*smooth(1, noEvent(if (L_l>= 0.95)
 then
     -M_dot/M_dot
 else
     M_dot/M_dot));
  ...
  annotation (Diagram(graphics), Icon(graphics={
        ...
        Rectangle(
          ...
          lineColor={0,0,0},
          fillPattern=FillPattern.Solid)}));
end Expansion_Tank_One_Port_Air_Draft;
