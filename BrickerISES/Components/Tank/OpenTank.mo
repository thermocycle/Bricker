...
model OpenTank "Storage tank with an imposed constant pressure"
...
L_l = Level;
fluidState = Medium.setState_ph(p_ext,h);
...
p - p_ext = g*L_l*rho;
// ALTERNATIVE
//p = p_ext "pressure in the tank equal to external pressure";
// this a sufficient simplification, and it permit to have non error shown during simulation initialization
