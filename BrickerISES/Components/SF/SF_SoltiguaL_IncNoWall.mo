...
ThermoCycle.Components.FluidFlow.Pipes.Cell1DimInc Cell_wf(
  ...
  Modelica.SIunits.Area S_total_sf "Total Area solar field";
record SummaryBase
    ...
    Modelica.SIunits.Area AsfTot = "Total collector area";
end SummaryBase;
  replaceable record SummaryClass = SummaryBase;
  SummaryClass Summary(Eta_solarCollector=Eta_tot,Q_htf = Q_tot,AsfTot=S_total_sf);
...
S_total_sf = SolarAbsorber.geometry.S_net*Ns*Nt;
